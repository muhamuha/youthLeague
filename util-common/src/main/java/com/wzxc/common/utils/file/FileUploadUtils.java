...
import com.wzxc.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils
{
     ...
     * @throws Exception
     */
    public static final String upload(MultipartFile file) throws FileSizeLimitExceededException, IOException {
        try
        {
            return upload(getDefaultBaseDir(), file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        }
        catch (FileSizeLimitExceededException | IOException | InvalidExtensionException e)
        {
